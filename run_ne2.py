...
dir_main = './saved_models/Nakagami_e2'
starting_from = False
nakagami_or_lognormal = 'nakagami'

# Set the noise 0.01 (e2) instead of 0.1 (e1, default)
# noise = 0.01 ->  N_G_var = 1 X 10^-16
dict_n_train["noise"] = 0.01
dict_n_test["noise"] = 0.01
